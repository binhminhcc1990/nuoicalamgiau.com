...
$ant_fau = "";
$ant_faucet = "00";
$fau_number = count(glob($_SERVER['DOCUMENT_ROOT']."/sitios/faucet/faucetbox/{*.php}",GLOB_BRACE));
$lim = "9";
...
$siguiente_fau = "../epay/02.php";
$total_epay = count(glob("../epay/{*.php}",GLOB_BRACE));
$next = "../epay/02.php";
$siguiente_fau = "../epay/02.php";
if (file_exists($siguiente_fau)) {$next = $next ;} else {$next = $url_base."sitios/faucet/xapo/01.php";};

if ($ant_faucet > "00") {
	$ant_faucet = $url_base."sitios/faucet/epay/00";

} else {
	$ant_faucet =  $url_base."sitios/faucet/faucetbox/".$fau_number;
};
...
<div id="botonera">
				...
				<p> '.$s_pago.' - Faucet 01/'.$total_epay.'</p>
...
</html> '; } else {header ("Location: /sitios/faucet/epay/02.php");};
?>
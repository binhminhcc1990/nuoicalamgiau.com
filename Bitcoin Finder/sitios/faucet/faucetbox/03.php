...
<div id="botonera">
				...
				<p> '.$s_pago.' - Faucet 03/'.$total_faucetbox.'</p>
...
</html> '; } else {header ("Location: /sitios/faucet/faucetbox/04.php");};
?>
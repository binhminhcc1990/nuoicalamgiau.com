...
<div id="botonera">
				...
				<p> '.$s_pago.' - Faucet 11/'.$total_faucetbox.'</p>
...
</html> '; } else {header ("Location: /sitios/faucet/faucetbox/12.php");};
?>
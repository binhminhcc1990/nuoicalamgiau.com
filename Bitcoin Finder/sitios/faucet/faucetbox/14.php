...
<div id="botonera">
				...
				<p> '.$s_pago.' - Faucet 14/'.$total_faucetbox.'</p>
...
</html> '; } else {header ("Location: /sitios/faucet/faucetbox/15.php");};
?>
...
<div id="botonera">
				...
				<p> '.$s_pago.' - Faucet 15/'.$total_faucetbox.'</p>
...
</html> '; } else {header ("Location: /sitios/faucet/faucetbox/16.php");};
?>
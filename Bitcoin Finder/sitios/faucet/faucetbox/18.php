...
<div id="botonera">
				...
				<p> '.$s_pago.' - Faucet 18/'.$total_faucetbox.'</p>
...
</html> '; } else {header ("Location: /sitios/faucet/faucetbox/19.php");};
?>